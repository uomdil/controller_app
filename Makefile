...
controller.elf : GSM.o main.o NFC.o keys.o UART.o Flash_Controller.o LCD.o skpic32_glcd.o TimeDelay.o
	$(CC) -mprocessor=32MX795F512L "GSM.o" "main.o" "NFC.o" "keys.o" "UART.o" "Flash_Controller.o" "LCD.o" "skpic32_glcd.o" "TimeDelay.o" -o"controller.elf" -Wl,-L"C:\Program Files (x86)\Microchip\MPLAB C32 Suite\lib",-L"C:\Program Files (x86)\Microchip\MPLAB C32 Suite\pic32mx\lib",--defsym=__MPLAB_BUILD=1,-Map="controller.map"
...
main.o : Logic/main.c include/global.h physical/keys.h include/global.h physical/Flash_Controller.h include/skpic32_glcd.h Common/grph.h
...
UART.o : Physical/UART.c include/global.h Physical/UART.h Physical/LCD.h include/global.h
...
skpic32_glcd.o : Common/skpic32_glcd.c include/Compiler.h include/TimeDelay.h include/GenericTypeDefs.h include/skpic32_glcd.h
...
clean : 
	$(RM) "GSM.o" "main.o" "NFC.o" "keys.o" "UART.o" "Flash_Controller.o" "LCD.o" "skpic32_glcd.o" "TimeDelay.o" "controller.elf" "controller.hex"
